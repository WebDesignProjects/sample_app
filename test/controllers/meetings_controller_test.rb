...
class MeetingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meeting" do
    assert_difference('Meeting.count') do
      post meetings_url, params: { meeting: { country_id: @meeting.country_id, name: @meeting.name } }
    end
  ...
  test "should update meeting" do
    patch meeting_url(@meeting), params: { meeting: { country_id: @meeting.country_id, name: @meeting.name } }
