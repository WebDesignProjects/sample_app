...
class AppearancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create appearance" do
    assert_difference('Appearance.count') do
      post appearances_url, params: { appearance: { horse_id: @appearance.horse_id, race_id: @appearance.race_id } }
    end
  ...
  test "should update appearance" do
    patch appearance_url(@appearance), params: { appearance: { horse_id: @appearance.horse_id, race_id: @appearance.race_id } }
