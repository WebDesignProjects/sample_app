...
class HorsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create horse" do
    assert_difference('Horse.count') do
      post horses_url, params: { horse: { name: @horse.name, probability: @horse.probability, ranking: @horse.ranking } }
    end
  ...
  test "should update horse" do
    patch horse_url(@horse), params: { horse: { name: @horse.name, probability: @horse.probability, ranking: @horse.ranking } }
